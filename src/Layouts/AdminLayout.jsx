...
const AdminLayout = () => {
    ...
    const adminItems = [
        ...
        { to: "/admin/chprofile", icon: Building2, label: "بيانات المؤسسة" },
        { to: "/admin/chcases", icon: HeartHandshake, label: "إدارة الحالات" },
        { to: "/admin/categories", icon: Tags, label: "فئات التبرعات" },
        { to: "/admin/donations", icon: History, label: "عمليات التبرع" },
        { to: "/admin/notifications", icon: BellRing, label: "الإشعارات" },
        { to: "/admin/profile", icon: UserCircle, label: "الملف الشخصي" },
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4 max-w-7xl mx-auto">
                        ...
                        <div className="text-center md:text-left order-1 md:order-2">
                            <p className="text-[10px] font-bold">
                                ...
                                <span className="text-indigo-600 dark:text-indigo-400 font-black mr-1">Code Spark System</span> © {new Date().getFullYear()}
                            </p>
                        </div>
